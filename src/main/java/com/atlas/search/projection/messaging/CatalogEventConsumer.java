...
public class CatalogEventConsumer {
  ...
  private void processFlightUpsert(EventEnvelope<FlightCatalogPayload> envelope,
  ...
  private void processHotelUpsert(EventEnvelope<HotelCatalogPayload> envelope,
      ConsumerEventType eventType) {
    eventValidator.validate(envelope);
    UUID eventId = envelope.eventId();
    log.info("Received {}: eventId={}", eventType, eventId);
