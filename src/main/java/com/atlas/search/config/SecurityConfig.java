    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers(publicMatchers)
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/search/flights")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/search/hotels")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/me/bookings")
                        .authenticated()
                        .anyRequest()
                        .denyAll())
